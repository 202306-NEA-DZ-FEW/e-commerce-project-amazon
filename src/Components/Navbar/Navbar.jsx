    ...
    <nav className=" relative">
      <div className="flex flex-col lg:flex-row h-full items-center justify-between p-4">
        ...
        <div
          className={`${
            isOpen ? "flex" : "hidden"
          } mt-5  relative lg:flex flex-col space-y-10 lg:space-y-0 w-full h-full items-center justify-around lg:justify-end lg:flex-row`}
        >
          <div className="flex flex-col space-y-2 md:space-y-0 lg:flex-row items-center">
            <div className="text-l lg:mx-7 lg:text-link font-medium">
              <a href="#services"> men clothing</a>
            </div>
            <div className="text-l lg:mx-7 lg:text-link font-medium">
              <a href="#me">women clothing</a>
            </div>
            <div className="text-l lg:mx-7 lg:text-link font-medium">
              <a href="/blog"> jewlery</a>
            </div>
          </div>
        </div>
      </div>
